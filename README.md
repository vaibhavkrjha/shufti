...
Shufti is an Advance Open Source Intelligence Framework, made by gathering many n number of tools all together under a single framwork to ease various process of recon, network firewall checking, vulnerability scanning, exploiting the pathched ones,enumerating the hosts. 
<br>
All the gathered outcomes will be saved in the designated Result Folder
